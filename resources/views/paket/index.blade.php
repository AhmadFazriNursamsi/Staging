...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight hetf2"><i class="bi bi-box2-fill"></i>
            {{ __('List package') }} <?php if($haveaccessadd): ?> <button type="button" class="btn btn-success btn-sm" id="buttonaddPaket"> <i class="bi bi-box2-fill"></i> Add package</button><?php endif; ?>
        </h2>
    </x-slot>
                                                    {{-- HEADER --}}
    <div class="py-12">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="table-responsive">
                        <table id="PaketTable" class="table text-start table-striped align-middle table-bordered table-hover mb-0">
                            <thead>
                                  <th>No</th>
                                  <th class="align-center">Package Name</th>
                            ...
                            <div class="table-option">
                                <table class="table table-striped" id="table_edit">
                                    <thead>
                                        <tr>
                                            <th class="nooo"></th>
                                            <th class="align-center">Name Product</th>
                                            <th class="align-center">Size</th>
                                            <th class="align-center">Another</th>
                    ...
                    if(query != '')  {  
                        $.ajax({  
                            ...
                            success:function(data) {  
                                ...
                                htmls1 += '<option value="" selected disabled hidden><b>choose package</b></option>'
